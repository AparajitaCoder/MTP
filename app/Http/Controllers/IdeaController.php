...
class IdeaController extends Controller
{
    ...
    public function postdetail($id)
    {
        ...
        ->where('i.type',2)
        ->orderBy('iv.total','desc')->paginate(10);
        return view('user.postdetail', compact('idea','id','buttonname','ideas','top10','top10ch','admin_script'));
    }  
    ...
    */
    ...
    public function invitations(Request $request)
    {
        ...
        $invs = DB::table('idea_applicants as iv')
                ->join('ideas as i','i.id','=','iv.idea_id')
                ->select('i.title', 'i.description', 'iv.created_at', 'iv.comment', 'iv.id', 'iv.status', 'iv.score', 'iv.vote', 'iv.total')
                ->where('i.solution_id',0)
                ->where('i.type',$type)
                ->where('iv.user_id',Auth::guard('user')->user()->id)
                ->orderBy('id','desc')->paginate(25);
        return view('user.invitations', compact('invs','type','admin_script'));
    } 
    ...
    public function ideas(Request $request)
    {
       ...
       $type = $request->query('type');
        ...
        return view('user.ideas', compact('ideas','type','admin_script'));
    } 
    ...
    public function inv_detail($id)
    {
        ...
        return view('user.inv_detail', compact('idea','id','convs','admin_script'));
    }
    ...
    public function mlt_index()
    {
        ...
        return view('user.mlt_index', compact('ideas','articles','solutions','winner','admin_script'));
    }
    ...
    {  
        ...
        return view('user.innovation', compact('ideas','top10','pchallanges','top10ch','admin_script'));
    }
    ...
    public function best_ideas(Request $request)
    {
        ...
        return view('user.best_ideas', compact('ideas','type','admin_script'));
    }
    ...
    public function wishlist(Request $request)
    {
        ...
        return view('user.wishlist', compact('ideas','type','admin_script'));
    }   
    ...
    public function setoffer($id)
    {
        ...
        return view('user.set_offer', compact('idea','id','convs','admin_script'));
    }
