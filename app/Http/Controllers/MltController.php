...
class MltController extends Controller
{
    ...
    {       
        ...
        return view('user.mlt.home', compact('settings','admin_script'));
    } 
    ...
    {   
        ...
        return view('user.mlt.index', compact('mps','cats','ca_id','keyword','admin_script'));
    } 
    ...
    public function userpost(Request $request)
    {
        ...
        $cats = Category::getList(); 
        return view('user.mlt.mypost', compact('mps','cats','admin_script'));
    }      
    ...
    public function show($id)
    {
        ...
        //dd($comments); exit;
        return view('user.mlt.show', compact('mp','comments','admin_script'));
    }
    ...
    {        
        $mp = Mltpost::findOrFail($id);
        $cats = Category::getList();           
        return view('user.mlt.edit',compact('mp','cats'));        
    }    
