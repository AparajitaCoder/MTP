        ...
        <div class="edit-profile-info">
          ...
          {{csrf_field()}}           
            <div class="row">
              ...
              <div class="col-md-12 pull-left labels">
                <span>Sex:</span>                
                <label for="Sex1">
                  ...
                  <div class="input-group">
                    <label class="input-group-btn">
                      <span class="btn btn-primary">
                      	<figure class="upload-link">
                        <img src="{{asset('/asset/images/file.png')}}" alt="" /> <input type="file" style="display: none;" name="profilepic">
                        </figure>
                      </span>
                    </label>                   
              ...
              <div class="col-md-12 pull-left">
                <div class="choose-file">
                  ...
                  <div class="input-group">
                    <label class="input-group-btn">
                      <span class="btn btn-primary">
                        <img src="{{asset('/asset/images/file.png')}}" alt="" /> <input type="file" style="display: none;" name="kebel">
                      </span>
                    </label>
                    <input type="text" class="form-control" disabled="" id="kebeltext" placeholder="Select file to upload" style="max-width:100%; min-width:255px;">
                  </div>
                </div>
              </div>
              <div class="col-md-12 pull-left">
                <div class="choose-file">
                  ...
                  <div class="input-group">
                    <label class="input-group-btn">
                      <span class="btn btn-primary">
                        <img src="{{asset('/asset/images/file.png')}}" alt="" /> <input type="file" style="display: none;" name="cv">
                      </span>
                    </label>
