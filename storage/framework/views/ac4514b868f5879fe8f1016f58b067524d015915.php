			...
			<ul class="nav navbar-nav float-md-right">
				<li class="nav-item dropdown hidden-sm-down">
					<a href="#" data-toggle="dropdown" aria-expanded="false">
							...
							<img src="<?php echo e(asset('/main/avatar.jpg')); ?>" alt="" style="display:inline-block;width:40px;">
							<p style="width: auto; display: inline-block;"><?php echo e(Auth::guard('admin')->user()->first_name.' '.Auth::guard('admin')->user()->last_name); ?></p>
