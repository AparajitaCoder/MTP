...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.departmemnt.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
            	...
            	<div class="form-group row">
					...
					<div class="col-xs-10">
						<div class="col-xs-10">
						<?php echo dropdown('branch_id',$categories); ?>
